...
int group_count = 0;
int last_connected1 = 0, last_connected2 = 0;
int connect_shortest(void) {
    ...
    if (circuit1 != circuit2) {
        ...
        group_count--;
        last_connected1 = index1;
        last_connected2 = index2;
        connected = 1;
    }
...
int main(int argc, char *argv[]) {
    ...
    // sort on sizes
    printf("Info: the calculated result is %ld.\n", (long)boxes[last_connected1].x * (long)boxes[last_connected2].x);
